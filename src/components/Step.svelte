...
<a class="p-4 sm:p-6 md:p-8 flex flex-col gap-4 rounded-lg border border-solid border-orange-700 text-center group cursor-pointer hover:border-orange-400 duration-200">
    ...
    <slot />
    <div class="flex-1 flex justify-between gap-4 items-counter">
